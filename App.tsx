...
const products = [
  ...
  {
    id: 2,
    image: "https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=765&q=80",
    brand: "ZARA",
      ...
      <main className="max-w-7xl mx-auto px-4 py-16">
        <section>
          <div className="flex justify-between items-center mb-8">
            ...
            <button className="text-pink-500 hover:text-pink-600">View All</button>
          </div>
        ...
        <section className="mt-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="relative h-[400px] overflow-hidden rounded-lg">
              <img
                src="https://images.unsplash.com/photo-1550246140-29f40b909e5a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white">Home & Living</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white">T&C</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">Terms Of Use</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">Track Orders</a></li>
            ...
            <div>
              <h4 className="text-lg font-semibold mb-4">EXPERIENCE MYNTRA APP ON MOBILE</h4>
